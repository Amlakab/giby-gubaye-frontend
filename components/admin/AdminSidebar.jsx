...
const menuItems = [
  ...
  { name: 'Programs', href: '/admin/program', icon: FileText },
  { name: 'Approve Agenda', href: '/admin/agenda-approve', icon: FileText },
  { name: 'Approve Programs', href: '/admin/approve-program', icon: FileText },
  { name: 'Add Programs', href: '/admin/add-program', icon: FileText },
